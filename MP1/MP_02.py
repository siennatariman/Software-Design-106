"""
    ...
    * Author's Name: Tariman, Sienna Ross M.
    * Group No.: 02
    * Date: Mach 26, 2021
    * Filename: MP_03.py
    * Program Description: This problem assumes that you have completed Problem 1. Place several Student objects into a list and shuffle it. Then run the sort method with this list and display all of the students’ information.
